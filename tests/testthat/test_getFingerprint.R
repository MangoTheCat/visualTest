...
test_that("getFingerprint", {
  ...
  cases <- list(
    "stest-01.png" = c(26, 27, 26, 25, 4, 5, 22, 8, 3, 9, 6, 6, 3, 3,
      3, 3, 3, 4, 8, 9, 3, 6, 24, 3, 6, 23, 26, 27, 24, 24),

    "stest-02.png" = c(26, 27, 26, 28, 28, 8, 3, 9, 6, 9, 3, 3, 3, 6,
      9, 9, 3, 6, 28, 28, 26, 27, 26, 24),

    "stest-03.png" = c(26, 27, 27, 24, 4, 5, 22, 8, 3, 9, 6, 6, 3, 3,
      3, 3, 3, 4, 8, 9, 3, 6, 24, 3, 6, 22, 27, 27, 26, 22),

    "stest-04.png" = c(25, 28, 25, 28, 24, 28, 5, 3, 6, 3, 6, 3, 3, 26,
      26, 28, 25, 28, 25, 23),

    "stest-05.png" = c(8, 6, 9, 7, 5, 8, 8, 5, 10, 7, 8, 5, 4, 3, 8,
      8, 10, 5, 5, 8, 7, 5, 8, 5, 5, 5, 8, 5, 7, 3,
      5, 7, 6, 5, 7, 5, 8, 5, 5, 5, 10, 5, 8, 10, 6,
      5, 4, 5, 8, 5, 10, 5, 8, 10, 5, 5, 8, 7, 6, 7),

    "stest-06.png" = c(8, 7, 6, 8, 5, 13, 8, 3, 10, 5, 7, 6, 8, 5, 4,
      9, 8, 6, 12, 5, 4, 9, 8, 6, 7, 8, 5, 10, 8, 6,
      7, 8, 7, 6, 5, 8, 8, 10, 5, 8, 5, 8, 4, 9, 5,
      9, 4, 8, 8, 10, 8, 4, 9, 8, 4),

    "ftest-01.png" = c(3, 7, 3, 9, 4, 3, 3, 23, 3, 3, 15, 3, 5, 21,
      3, 5, 14, 7, 6, 3, 5, 5, 3, 13, 6, 45, 7, 11, 3,
      5, 5, 6, 3, 7, 16, 3, 3, 23, 3, 3, 15, 3, 5, 21,
      3, 4, 3, 9, 3, 7),

    "ftest-02.png" = c(5, 5, 4, 7, 8, 8, 16, 12, 9, 8, 5, 8, 8, 5, 3,
