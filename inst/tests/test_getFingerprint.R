...
test_that("getFingerprint", {
  ...
  cases <- list(
    "stest-00.jpg" = c(20, 26, 27, 27, 24, 4, 5, 22, 8, 3, 9, 6, 6, 3,
      3, 3, 3, 3, 4, 8, 9, 3, 6, 24, 3, 6, 22, 27, 27, 24, 23, 4),
    ...
    "ftest-01.png" = c(4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12,
      4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4,
      12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12,
      4, 4, 12, 4, 4),

    "ftest-02.png" = c(4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4,
      12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12,
      4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4, 4, 12, 4,
      4, 12, 4, 4, 12, 4, 4)
  )
